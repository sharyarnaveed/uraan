...
const notapprovedrojects=async(id)=>
{
try {
  const responce=await api.post("/api/admin/notapproved",{id:id})
  console.log(responce.data);
  ...
  console.log("error in not approving project",error);
              ...
              <div className="card" key={item.project_id}>
                ...
                <div className="card-buttons">
                  ...
                  <button className="reject-btn" onClick={()=>
                    {
                      notapprovedrojects(item.project_id)
                    }
                  }>Not Approved</button>
